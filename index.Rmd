...
Utilizaremos el lenguaje `r latex::textsf('R')`, vía la IDE (*Integrated Development Environment*) `r latex::textsf('RStudio')`, para resolver las tareas que se plantearán en la asignatura.
